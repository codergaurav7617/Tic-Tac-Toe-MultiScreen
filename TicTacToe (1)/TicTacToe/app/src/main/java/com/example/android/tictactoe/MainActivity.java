...
import com.example.android.tictactoe.StartActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    in.codingninjas.tictactoe.tictactoe.CustomButton[][] board = new in.codingninjas.tictactoe.tictactoe.CustomButton[size][size];
    ...
    public void setUpBoard(){
        ...
        board = new com.example.gaurav_jaiswal.tictactoe.CustomButton[size][size];
        ...
        for(int i = 0;i<size;i++){
            for(int j = 0;j<size;j++){
                ...
                com.example.gaurav_jaiswal.tictactoe.CustomButton button = new com.example.gaurav_jaiswal.tictactoe.CustomButton(this);
    ...
    public void onClick(View view) {
       ...
       if(currentStatus == INCOMPLETE){
           com.example.gaurav_jaiswal.tictactoe.CustomButton customButton = (com.example.gaurav_jaiswal.tictactoe.CustomButton)view;
